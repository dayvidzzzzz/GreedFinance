...
public class CreateUserUseCase {
    ...
    public UserCreateResponseDTO execute(User userMaster, UserCreateRequestDTO dto){
        ...
        Tenant tenant = userMaster.getTenant();
        ...
        return toResponse(savedUser, roleUser);
    }

    private UserCreateResponseDTO toResponse(User user, Role role){
        return new UserCreateResponseDTO(
                ...
                user.getUsername(),
                user.getCreateAt(),
                new UserCreateResponseDTO.RoleResponse(
                        role.getName()
                ),
                new UserCreateResponseDTO.TenantResponse(
